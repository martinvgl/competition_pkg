...
#     self.node.get_logger().info("NAVIGATION STATE")

#     if not rclpy.ok():
#         return "failed"

#     # Move to evacuation/exit point
#     self.goToPose(
#         x=0.0,
#         y=0.0,
#         yaw=0.0
...
"""
navigation.py
Navigation state for evacuation robot
"""
...
class NavigationState(State):
    ...
    def execute(self, blackboard: Blackboard):
        ...
        # Example evacuation point
        success = self.goToPose(
            x=0.0,
            y=0.0,
            yaw=0.0
        )
        ...
        while not self.isNavComplete():
            ...
            if self._feedback:
                ...
                self.node.get_logger().info(
                    ...
                    f"{self._feedback.distance_remaining:.2f}"
                )
